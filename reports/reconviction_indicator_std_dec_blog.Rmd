...
This also means that we don't know exactly how much of the fall in the overall reconviction rate is due to reductions in reoffending, and how much is due to these changes in offender mix.
<!---
...
[^3]: The code and data used for our analysis are available [here](https://github.com/josiahpjking/decomposition_standardisation).
